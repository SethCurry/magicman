...
func (cc *ColorCreate) SetCode(s string) *ColorCreate {
	cc.mutation.SetCode(s)
	return cc
}

// AddCardIDs adds the "cards" edge to the Card entity by IDs.
func (cc *ColorCreate) AddCardIDs(ids ...int) *ColorCreate {
	cc.mutation.AddCardIDs(ids...)
	return cc
}

// AddCards adds the "cards" edges to the Card entity.
func (cc *ColorCreate) AddCards(c ...*Card) *ColorCreate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cc.AddCardIDs(ids...)
}
...
func (cc *ColorCreate) createSpec() (*Color, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.CardsIDs(); len(nodes) > 0 {
