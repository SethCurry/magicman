...
func (cq *ColorQuery) QueryCards() *CardQuery {
...
func (cq *ColorQuery) WithCards(opts ...func(*CardQuery)) *ColorQuery {
	query := &CardQuery{config: cq.config}
...
func (cq *ColorQuery) sqlAll(ctx context.Context) ([]*Color, error) {
	...
	if query := cq.withCards; query != nil {
		fks := make([]driver.Value, 0, len(nodes))
		ids := make(map[int]*Color, len(nodes))
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(color.CardsPrimaryKey[0], fks...))
			},
