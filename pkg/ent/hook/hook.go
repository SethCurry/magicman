...
// The DeckCardFunc type is an adapter to allow the use of ordinary
// function as DeckCard mutator.
type DeckCardFunc func(context.Context, *ent.DeckCardMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeckCardFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DeckCardMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DeckCardMutation", m)
	}
	return f(ctx, mv)
}
...
type RulingFunc func(context.Context, *ent.RulingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RulingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.RulingMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RulingMutation", m)
	}
	return f(ctx, mv)
}
...
// The SuperTypeFunc type is an adapter to allow the use of ordinary
// function as SuperType mutator.
type SuperTypeFunc func(context.Context, *ent.SuperTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SuperTypeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SuperTypeMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SuperTypeMutation", m)
	}
	return f(ctx, mv)
}
