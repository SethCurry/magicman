...
func ID(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func IDLT(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func HasCards() predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
...
func HasCardsWith(preds ...predicate.Card) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func And(predicates ...predicate.SubType) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.SubType) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.SubType) predicate.SubType {
	return predicate.SubType(func(s *sql.Selector) {
		p(s.Not())
	})
}
